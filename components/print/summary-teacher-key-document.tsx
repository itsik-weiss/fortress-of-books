...
export function SummaryTeacherKeyDocument() {
  return (
    <div className="pdf-doc mx-auto max-w-[210mm] bg-white text-stone-900">
      <PdfCover
        variant="summary"
        emoji="🔑"
        kicker="למורה בלבד · סיכום דרך עבודה"
        title="מפתח תשובות · סיכום"
        subtitle="כל 25 המשימות עם רמז וניסוח לדוגמה. השתמשו אחרי שהקבוצה כתבה תוצר. אין חובה להעתיק את הניסוח."
      />
        ...
        {summaryCards.map((card) => {
          ...
          return (
            ...
            >
              ...
              <div className="mt-2 rounded-xl bg-indigo-50 p-3 text-sm leading-7 text-indigo-950">
